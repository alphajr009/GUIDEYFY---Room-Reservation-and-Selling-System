...
function Createpromotion() {
    ...
    async function addPromotion() {
        ...
        try {
            setloading(true)
                const data = (await axios.get("http://localhost:5000/api/promotions/addpromotion", newpromotion)).data
        ...
        <div>
            ...
            <div className="PromotionForm">
                ...
                <div className="createPromotionForm">
                    ...
                    <div className="promotion-form-input">
                        <input type="submit" value="Create Promotion" onClick={addPromotion} className='pro-submit-btn' />
                    </div>
